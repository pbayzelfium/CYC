...
$Manifest = [ordered]@{
  '.oh-my-posh/palettes.json' = $true
  '.oh-my-posh/build-variants.ps1' = $true
  '.oh-my-posh/pair-prompt.py' = $true
  '.oh-my-posh/theme-tools.ps1' = $true
  ...
  '.oh-my-posh/cyc-update.ps1' = $true
  ...
  '.oh-my-posh/catalogue/catalogue-template.html' = $false
  '.oh-my-posh/catalogue/rebuild.ps1' = $false
  '.oh-my-posh/cyc.omp.json' = $true
  '.oh-my-posh/schemes.json' = $true
  '.oh-my-posh/catalogue/theme-catalogue.html' = $true
}
# ---------------------------------------------------------------------------
